...
<html>
    ...
    <div class="body">
        ...
        <div class="product-list">
            <a class="product" href="../../trangchitiet/lego/lego1.php">
            ...
            <a class="product" href="../../trangchitiet/lego/lego2.php">
            ...
            <a class="product" href="../../trangchitiet/lego/lego3.php">
            ...
            <a class="product" href="../../trangchitiet/lego/lego4.php">
        ...
        <a href="index2.php"><button class="page">2</button></a>
        </div>
    </div>
