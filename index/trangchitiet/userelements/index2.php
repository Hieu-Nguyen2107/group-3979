...
<html>
            ...
            <div id="header">
              ...
              <ul class="menubar" id="nav">
                ...
                <div class="user-container">
                    <a id="login-link" href="login.htm" class="login-link"><span id="taikhoan"> Đăng nhập</span></a>
                    <a id="linkLogOut2" href="register.htm" class="register-link" onclick="checkLogOut2()"><span id="dangxuat">Đăng ký</span></span></a>
                    <i class="user-icon ti-user"></i>
                </div>
      
                <!-- Thêm phần giỏ hàng -->
                   <div class="cart-container">
                  <a href="shoppingCart.htm" class="cart-icon ti-shopping-cart"></a>
    ...
    <div class="body">
        ...
        <div class="product-list">
            <a class="product" href="../../trangchitiet/lego/lego1.htm">
            ...
            <a class="product" href="../../trangchitiet/lego/lego2.htm">
            ...
            <a class="product" href="../../trangchitiet/lego/lego3.htm">
            ...
            <a class="product" href="../../trangchitiet/lego/lego4.htm">
        ...
        <div class="product-list">
            <a class="product" href="../../trangchitiet/dcvd/dcvd1.htm">
            ...
            <a class="product" href="../../trangchitiet/dcvd/dcvd2.htm">
            ...
            <a class="product" href="../../trangchitiet/dcvd/dcvd3.htm">
        ...
        <a href="../../index.htm"><button class="page">1</button></a>
        <a href="index2.htm"><button class="page">2</button></a>
        </div>
    </div>
