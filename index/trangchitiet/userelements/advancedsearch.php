...
<html>
  ...
  <body onload="changeName();changeLinkIndex2();">
        ...
        <ul class="menubar" id="nav">
          ...
          <li>
            ...
            <ul class="subnav">
              ...
              <li>
                <a href="../phanloaisanpham/bupbe.htm">BÚP BÊ</a>
              </li>
              <li>
                <a href="../phanloaisanpham/dochoilapghep.htm"
                  >ĐỒ CHƠI LẮP GHÉP</a
                >
              </li>
              <li>
                <a href="../phanloaisanpham/dochoivandong.htm"
                  >ĐỒ CHƠI VẬN ĐỘNG</a
                >
              </li>
            </ul>
    ...
    <div class="inform">
      <form action="../phanloaisanpham/timkiemnangcao1.htm">
