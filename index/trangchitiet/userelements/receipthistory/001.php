...
<html>
    ...
    <body onload="changeName();changeLinkReceiptHistory();">
            ...
            <div id="header">
              ...
              <ul class="menubar" id="nav">
                ...
                <li>
                  ...
                  <ul class="subnav">
                    <li>
                      <a href="../../phanloaisanpham/robot.htm">ROBOT</a>
                    </li>
                    <li>
                      <a href="../../phanloaisanpham/doll.htm">BÚP BÊ</a>
                    </li>
                    <li>
                      <a href="../../phanloaisanpham/lego.htm"
                        >ĐỒ CHƠI LẮP GHÉP</a
                      >
                    </li>
                    <li>
                      <a href="../../phanloaisanpham/dcvd.htm"
                        >ĐỒ CHƠI VẬN ĐỘNG</a
                      >
                    </li>
                  </ul>
                ...
                <div class="user-container">
                  ...
                  <a id="linkLogOut2" href="../register.htm" class="register-link" onclick="checkLogOut3();"><span id="dangxuat">Đăng ký</span></span></a>
      ...
      <a class="back-button" href="../accountinform.htm"><button class="ti-arrow-left"><span style="margin-left: 4px;word-spacing: -3px;"><b>Quay lại</b></span></button></a>
      </div>
