    ...
    <body onload="changeName();changeLinkProduct();">
      <header>
        ...
        <div class="img-product">
            <img class="img-chitiet" src="../../productImage/doll/doll2.jpg">
        </div>
        <div>
        <div style="max-width: fit-content;">
            <div class="product-name"><b>Bánh Mì Barber Bread BREAD BARBERSHOP</b></div>
            ...
            <div style="line-height: 30px;"> <!--Describe-->
                ...
                <p>
                <h3> Bánh Mì Barber Bread BREAD BARBERSHOP BB32773</h3>
            ...
            <div style="float: right;margin: 15px 30px;"><a href="../../index.htm"><button style="font-size: 17px;"><i class="ti-arrow-left"></i>Quay lại</button></a></div>
          </div>
        </div>
        <footer>
            <ul style="padding-left: 3%;" class="footer">
