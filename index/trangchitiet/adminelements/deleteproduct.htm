...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Delete Product 3979 Toys</title>
    ...
    <body>
        ...
        <h1 style="margin: 30px 15px;text-align: center;">Xóa Sản Phẩm</h1>
        <div class="body">
            ...
            <div  class="product-list">
                <div class="product">    <!--DONE-->
                    ...
                    <div class="product-detail">
                        ...
                        <div class="icon"><button class="ti-trash" onclick="confirm('Bạn có chắc chắn muốn xóa sản phẩm này không?')"></button></div>
                    </div>
                </div>
                <div class="product">    <!--DONE-->
