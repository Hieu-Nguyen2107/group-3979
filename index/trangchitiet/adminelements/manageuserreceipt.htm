...
<html>
    ...
    <body>
      <header style="width: 100%;">
        <div id="header">
          ...
          <ul class="menubar" id="nav">
            <li><a href="../../indexadmin.htm" onclick="">home</a></li>
            <!-- Thêm phần tìm kiếm -->
      ...
      <div class="body-manageuserreceipt">
          ...
          <div class="frame-userreceipt">
            <div id="receipt1" class="receipt">
              <span id="code">MÃ ĐƠN HÀNG #001
                <a href="../receipt/receipt1.htm">Xem thông tin đơn hàng</a>
              </span>
            ...
            <div id="receipt2" class="receipt">
              <span id="code">MÃ ĐƠN HÀNG #002
                <a href="../receipt/receipt2.htm">Xem thông tin đơn hàng</a>
              </span>
            ...
            <div id="receipt3" class="receipt">
              <span id="code">MÃ ĐƠN HÀNG #003
                <a href="../receipt/receipt3.htm">Xem thông tin đơn hàng</a>
              </span>
            ...
            <div id="receipt4" class="receipt">
              <span id="code">MÃ ĐƠN HÀNG #004
                <a href="../receipt/receipt4.htm">Xem thông tin đơn hàng</a>
              </span>
            ...
            <div id="receipt5" class="receipt">
              <span id="code">MÃ ĐƠN HÀNG #005
                <a href="../receipt/receipt5.htm">Xem thông tin đơn hàng</a>
              </span>
        ...
        <a href="../../indexadmin.htm" style="margin-left: auto;margin-right: 15px;margin-top: 10px;"><button style="padding: 5px 15px;cursor: pointer;"><i class="ti-home" style="margin-right: 5px;"></i>Quay lại trang chủ</button></a>
      </div>
