            ...
            <div  class="product-list">
                <div class="product">    <!--DONE-->
                    ...
                    <div class="product-detail">
                        ...
                        <div class="icon"><a href="updateproduct/robot/robot1.htm"><button class="ti-settings"></button></a></div>
                    </div>
                </div>
                <div class="product">    <!--DONE-->
                    ...
                    <div class="product-detail">
                        ...
                        <div class="icon"><a href="updateproduct/robot/robot2.htm"><button class="ti-settings"></button></a></div>
                    </div>
                </div>
                <div class="product">    <!--DONE-->
                    ...
                    <div class="product-detail">
                        ...
                        <div class="price">799,000 VNĐ</div>
                        <div class="icon"><a href="updateproduct/robot/robot3.htm"><button class="ti-settings"></button></a></div>
                    </div>
                </div>
                <div class="product">
                    ...
                    <div class="product-detail">
                        ...
                        <div class="icon"><a href="updateproduct/robot/robot4.htm"><button class="ti-settings"></button></a></div>
                    </div>
                </div>
            </div>
            ...
            <div class="product-list">
                <div class="product">
                    ...
                    <div class="product-detail">
                        ...
                        <div class="icon"><a href="updateproduct/doll/doll1.htm"><button class="ti-settings"></button></a></div>
                    </div>
                </div>
                <div class="product">
                    ...
                    <div class="product-detail">
                        ...
                        <div class="icon"><a href="updateproduct/doll/doll2.htm"><button class="ti-settings"></button></a></div>
                    </div>
                </div>
                <div class="product">
                    ...
                    <div class="product-detail">
                        ...
                        <div class="icon"><a href="updateproduct/doll/doll3.htm"><button class="ti-settings"></button></a></div>
                    </div>
                </div>
                <div class="product">
                    ...
                    <div class="product-detail">
                        ...
                        <div class="icon"><a href="updateproduct/doll/doll4.htm"><button class="ti-settings"></button></a></div>
                    </div>
                </div>
            </div>
            ...
            <div class="product-list">
                <div class="product">
                    ...
                    <div class="product-detail">
                        ...
                        <div class="icon"><a href="updateproduct/lego/lego1.htm"><button class="ti-settings"></button></a></div>
                    </div>
                </div>
                <div class="product">
                    ...
                    <div class="product-detail">
                        ...
                        <div class="icon"><a href="updateproduct/lego/lego2.htm"><button class="ti-settings"></button></a></div>
                    </div>
                </div>
                <div class="product">
                    ...
                    <div class="product-detail">
                        ...
                        <div class="icon"><a href="updateproduct/lego/lego3.htm"><button class="ti-settings"></button></a></div>
                    </div>
                </div>
                <div class="product">
                    ...
                    <div class="product-detail">
                        ...
                        <div class="icon"><a href="updateproduct/lego/lego4.htm"><button class="ti-settings"></button></a></div>
                    </div>
                </div>
            </div>
            ...
            <div class="product-list">
                <div class="product">
                    ...
                    <div class="product-detail">
                        ...
                        <div class="icon"><a href="updateproduct/dcvd/dcvd1.htm"><button class="ti-settings"></button></a></div>
                    </div>
                </div>
                <div class="product">
                    ...
                    <div class="product-detail">
                        ...
                        <div class="icon"><a href="updateproduct/dcvd/dcvd2.htm"><button class="ti-settings"></button></a></div>
                    </div>
                </div>
                <div class="product">
                    ...
                    <div class="product-detail">
                        ...
                        <div class="icon"><a href="updateproduct/dcvd/dcvd3.htm"><button class="ti-settings"></button></a></div>
                    </div>
                </div>
                <div class="product">
                    ...
                    <div class="product-detail">
                        ...
                        <div class="icon"><a href="updateproduct/dcvd/dcvd4.htm"><button class="ti-settings"></button></a></div>
                    </div>
                </div>
            </div>
            <a href="../../indexadmin.htm" style="float: right;margin-right: 45px;margin-top: 20px;"><button style="padding: 5px 15px;cursor: pointer;"><i class="ti-home" style="margin-right: 5px;"></i>Quay lại trang chủ</button></a>
        </div>
