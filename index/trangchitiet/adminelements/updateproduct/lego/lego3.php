    ...
    <body>
        ...
        <div style="display: flex;margin-top: 40px;">
            <div class="img-product">
                <div><img id="delete" class="img-chitiet" src="../../../../productImage/lego/lego3.jpg"></div>
                <div class="add-img">
                    <div id="img-delete" class="element delete" onclick="deleteIMG();">
                        <img id="need-delete" src="../../../../productImage/lego/lego3.jpg" style="display: block;">
            ...
            <div>
                ...
                <div id="body" contenteditable="false">
                    <div style="max-width: fit-content;">
                        <div class="product-name"><b>Đồ chơi lắp ráp Phiên chợ Vương quốc Rosa LEGO DISNEY PRINCESS 43223</b>
                        </div>
                        <div class="product-price"><b>629,000 VNĐ</b>
                        </div>
                    </div>
