    ...
    <body>
        ...
        <div style="display: flex;margin-top: 40px;">
            ...
            <div class="img-product">
                <div><img id="delete" class="img-chitiet" src="../../../../productImage/robot/robot1.jpg"></div>
                <div class="add-img">
                    <div id="img-delete" class="element delete" onclick="deleteIMG();">
                        <img id="need-delete" src="../../../../productImage/robot/robot1.jpg" style="display: block;">
            ...
            <div>
                ...
                <div id="body" contenteditable="false">
                    <div style="max-width: fit-content;">
                        <div class="product-name"><b><span>Robot chú chó tinh nghịch</span></b>
                            </div>
                        <div class="product-price"><b>649,000 VNĐ</b>
