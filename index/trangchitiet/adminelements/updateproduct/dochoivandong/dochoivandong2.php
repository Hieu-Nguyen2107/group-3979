    ...
    <body>
        ...
        <div style="display: flex;margin-top: 40px;">
            <div class="img-product">
                <div><img id="delete" class="img-chitiet" src="../../../../productImage/dochoivandong/dcvd2.jpg"></div>
                <div class="add-img">
                    <div id="img-delete" class="element delete" onclick="deleteIMG();">
                        <img id="need-delete" src="../../../../productImage/dochoivandong/dcvd2.jpg" style="display: block;">
        ...
        <div>
            ...
            <div id="body" contenteditable="false">
                <div style="max-width: fit-content;">
                    <div class="product-name"><b>Trò chơi trận chiến không gian CHAMPION GAMES HG1012001</b>
                    </div>
                    <div class="product-price"><b>359,000 VNĐ</b>
                    </div>
                </div>
