...
<html>
    ...
    <body>
      <header>
        <div id="header">
          ...
          <ul class="menubar" id="nav">
            <li><a href="../adminelements/manageuserreceipt.htm">home</a></li>
            <!-- Thêm phần tìm kiếm -->
        ...
        <div class="user-container" style="margin-left: auto;margin-right: 30px;">
              <div class="admin-popup">
                ...
                <div>
                  <img src="../adminelements/avauser/moi.jpg"><span>Moi</span>
                </div>
                <!-- <div class="popup">
                  <div>
      ...
      <div class="body-receipt">
        ...
        <div id="code"><h1>MÃ ĐƠN HÀNG: #005</h1></div>
        ...
        <div id="receipt-list">
            ...
            <div id="product">
              ...
              <div id="detail">
                  ...
                  <span id="price-container"><b>Tổng cộng: &#8363 <span id="price">799,000 VNĐ</span></b></span>
              </div>
            </div>
            <div id="product">
                <img src="../../productImage/dochoivandong/dcvd3.jpg">
                <div id="name">
                  Đồ Chơi Máy Gắp Thú Kích Thước Lớn Có Đèn Và Nhạc CHAMPION GAMES CPG762
                </div>
                <div id="detail">
                    <span id="amount">x1</span> <br/>
                    <span>&#8363 699,000 VNĐ</span> <br/>
                    <span id="price-container"><b>Tổng cộng: &#8363 <span id="price">699,000 VNĐ</span></b></span>
                </div>
            </div>
            ...
            <div id="product">
                ...
                <div id="name">
                  Đồ Chơi Máy Đập Hành Tinh Chuột Chũi CHAMPION GAMES HG1503066

                </div>
                <div id="detail">
                    <span id="amount">x1</span> <br/>
                    <span>&#8363 459,000 VNĐ</span> <br/>
                    <span id="price-container"><b>Tổng cộng: &#8363 <span id="price">459,000 VNĐ</span></b></span>
                </div>
            </div>

            <div id="sum">
                <span id="logo"><b><i class="ti-money"></i>Thành tiền:</b></span>  <br/>
                <span id="total-price">&#8363 1,957,000 VNĐ</span>
            </div>
      </div>
      <a class="back-button" href="../adminelements/manageuserreceipt.htm"><button class="ti-arrow-left"><span style="margin-left: 4px;word-spacing: -3px;"><b>Quay lại</b></span></button></a>
      </div>
