...
<html>
    ...
    <body>
      <header>
        <div id="header">
          ...
          <ul class="menubar" id="nav">
            <li><a href="../adminelements/manageuserreceipt.php">home</a></li>
            <!-- Thêm phần tìm kiếm -->
      ...
      <a class="back-button" href="../adminelements/manageuserreceipt.php"><button class="ti-arrow-left"><span style="margin-left: 4px;word-spacing: -3px;"><b>Quay lại</b></span></button></a>
      </div>
