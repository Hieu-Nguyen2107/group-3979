    ...
    <body onload="changeName();changeLinkProduct();">
      <header>
        ...
        <div class="img-product">
            <img class="img-chitiet" src="../../productImage/robot/robot2.jpg">
        </div>
        <div>
        <div style="max-width: fit-content;">
            <div class="product-name"><b>Mô hình Earthspark Warrior Thrash</b></div>
            <div class="product-price"><b>799,000 VNĐ</b></div>
            <div style="display: flex;margin-left: 30px;">
              <button class="button-amount decrease"><i class="ti-minus"></i></button>
              <input class="amount" type="text" value="1" readonly>
              <button class="button-amount increase"><i class="ti-plus"></i></button>            </div>
              <script>
            ...
            <div style="float: right;margin: 20px 30px;"><a href="../../index.htm"><button style="font-size: 17px;"><i class="ti-arrow-left"></i>Quay lại</button></a></div>
            </div>
        </div>
