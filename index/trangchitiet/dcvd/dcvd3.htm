    ...
    <body onload="changeName();changeLinkProduct();">
      <header>
        ...
        <div class="img-product">
            <img class="img-chitiet" src="../../productImage/dochoivandong/dcvd3.jpg">
        </div>
        <div>
        <div style="max-width: fit-content;">
            <div class="product-name"><b>Máy gắp thú kích thước lớn có đèn và nhạc CHAMPION GAMES CPG762 </b></div>
            <div class="product-price"><b>699,000 VNĐ</b></div>
