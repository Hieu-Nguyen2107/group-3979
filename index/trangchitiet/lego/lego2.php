    ...
    <body onload="changeName();changeLinkProduct();">
      <header>
        ...
        <div class="img-product">
            <img class="img-chitiet" src="../../productImage/lego/lego2.jpg">
        </div>
        <div>
        <div style="max-width: fit-content;">
            <div class="product-name"><b>Đồ chơi lắp ráp Vườn bách thảo LEGO FRIENDS 41757</b></div>
            <div class="product-price"><b>2,599,000 VNĐ</b></div>
