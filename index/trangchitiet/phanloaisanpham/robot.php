  ...
  <body onload="changeName();changeLinkProduct();">
    ...
    <div class="body">
      ...
      <div class="product-list">
        <a class="product" href="../../trangchitiet/robot/robot1.htm">
          <!--DONE-->
        ...
        <a class="product" href="../../trangchitiet/robot/robot2.htm">
          <!--DONE-->
        ...
        <a class="product" href="../../trangchitiet/robot/robot3.htm">
          <!--DONE-->
      ...
      <div style="margin-left: 48%">
        <a href="robot.htm"><button class="page">1</button></a>
      </div>
    </div>
