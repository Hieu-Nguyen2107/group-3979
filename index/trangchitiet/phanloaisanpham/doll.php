  ...
  <body onload="changeName();changeLinkProduct();">
    ...
    <div class="body">
      ...
      <div class="product-list">
        <a class="product" href="../doll/doll1.htm">
        ...
        <a class="product" href="../doll/doll2.htm">
        ...
        <a class="product" href="../doll/doll3.htm">
        ...
        <a class="product" href="../doll/doll4.htm">
      ...
      <div style="margin-left: 48%">
        <a href="doll.htm"><button class="page">1</button></a>
      </div>
    </div>
