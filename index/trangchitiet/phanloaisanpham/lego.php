  ...
  <body onload="changeName();changeLinkProduct();">
    ...
    <div class="body">
      ...
      <div class="product-list">
        <a class="product" href="../lego/lego1.htm">
          <img src="../../productImage/lego/lego1.jpg" />
          <div class="product-detail">
            <div class="name">
              Đồ chơi lắp ráp Phi thuyền X-Wing Starfighter™ LEGO STAR WARS
            </div>
            <div class="price">7,559,000 VNĐ</div>
          </div>
        </a>
        <a class="product" href="../lego/lego2.htm">
        ...
        <a class="product" href="../lego/lego3.htm">
          <img src="../../productImage/lego/lego3.jpg" />
          <div class="product-detail">
            <div class="name">
              Đồ chơi lắp ráp Phiên chợ Vương quốc Rosa LEGO DISNEY PRINCESS
            </div>
            <div class="price">629,000 VNĐ</div>
          </div>
        </a>
        <a class="product" href="../lego/lego4.htm">
          <img src="../../productImage/lego/lego4.jpg" />
          <div class="product-detail">
            <div class="name">
              Đồ chơi lắp ráp Học viện Ma thuật và Pháp thuật Hogwarts LEGO
              HARRY POTTER
            </div>
      ...
      <div style="margin-left: 48%">
        <a href="lego.htm"><button class="page">1</button></a>
      </div>
    </div>
