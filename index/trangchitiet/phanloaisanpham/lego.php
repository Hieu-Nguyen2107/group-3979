  ...
  <body onload="changeName();changeLinkProduct();">
    ...
    <div class="body">
      ...
      <div class="product-list">
        <a class="product" href="../lego/lego1.php">
        ...
        <a class="product" href="../lego/lego2.php">
        ...
        <a class="product" href="../lego/lego3.php">
        ...
        <a class="product" href="../lego/lego4.php">
      ...
      <div style="margin-left: 48%">
        <a href="lego.php"><button class="page">1</button></a>
      </div>
    </div>
