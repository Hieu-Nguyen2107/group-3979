  ...
  <body onload="changeName();changeLinkProduct();">
    ...
    <div class="body">
      ...
      <div class="product-list">
        <a class="product" href="../dcvd/dcvd1.php">
        ...
        <a class="product" href="../dcvd/dcvd2.php">
        ...
        <a class="product" href="../dcvd/dcvd3.php">
        ...
        <a class="product" href="../dcvd/dcvd4.php">
      ...
      <div style="margin-left: 48%">
        <a href="dcvd.php"><button class="page">1</button></a>
      </div>
    </div>
