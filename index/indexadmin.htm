        ...
        <h1 style="text-align: center; margin-top: 20px;">BẠN ĐANG SỬ DỤNG CHẾ ĐỘ ADMIN</h1>
          <div class="function">
            ...
            <div id="product-manage-menu">
              <div><a href="trangchitiet/adminelements/addproduct.htm"><button>Thêm Sản Phẩm</button></a></div> <!--DONE-->
              <div><a href="trangchitiet/adminelements/deleteproduct.htm"><button>Xóa Sản Phẩm</button></a></div> <!--DONE-->
              <div><a href="trangchitiet/adminelements/updateproduct.htm"><button>Sửa Sản Phẩm</button></a></div> <!--DONE-->
            </div>
            </div>
            <script>
            ...
            <div id="user-manage-menu">
              <div><a href="trangchitiet/adminelements/checkuser.htm"><button>Kiểm Tra Thông Tin Người Dùng</button></a></div><!--DONE-->
              <div><a href="trangchitiet/adminelements/adduser.htm"><button>Thêm Người Dùng</button></a></div>  <!--DONE-->
              <div><a href="trangchitiet/adminelements/updateuser.htm"><button>Sửa Thông Tin Người Dùng</button></a></div>  <!--DONE-->
              <div><a href="trangchitiet/adminelements/lockuser.htm"><button>Khóa Người Dùng</button></a></div> <!--DONE-->
            </div>
            </div>
            <div><a href="trangchitiet/adminelements/manageuserreceipt.htm"><button>Quản Lý Đơn Hàng Người Dùng</button></a></div><!--Xem chi tiết các đơn hàng, hiện thỉ trạng thái đơn hàng (đang đóng gói,đang vận chuyển, đã giao)-->
            <div><a href="trangchitiet/adminelements/statistics.htm"><button>Thống Kê Tình Hình Kinh Doanh</button></a></div><!--Hiện thỉ và tính tổng các đơn hàng theo tiêu chí : số lượng sản phẩm của 1 loại sản phẩm khoảng thời gian-->
          </div>
