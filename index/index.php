...
<html>
    ...
    <div class="body">
        ...
        <div  class="product-list">
            <a class="product" href="trangchitiet/robot/robot1.php">    <!--DONE-->
            ...
            <a class="product" href="trangchitiet/robot/robot2.php">    <!--DONE-->
            ...
            <a class="product" href="trangchitiet/robot/robot3.php">    <!--DONE-->
            ...
            <a class="product" href="trangchitiet/robot/robot4.php">
        ...
        <div class="product-list">
            <a class="product" href="trangchitiet/doll/doll1.php">
            ...
            <a class="product" href="trangchitiet/doll/doll2.php">
            ...
            <a class="product" href="trangchitiet/doll/doll3.php">
            ...
            <a class="product" href="trangchitiet/doll/doll4.php">
        ...
        <a href="index.php"><button class="page">1</button></a>
