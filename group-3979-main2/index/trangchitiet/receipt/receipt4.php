...
<html>
    ...
    <body>
      ...
      <div class="body-receipt">
        ...
        <div id="code"><h1>MÃ ĐƠN HÀNG: #004</h1></div>
        ...
        <div id="receipt-list">
            ...
            <div id="product">
                ...
                <div id="name">
                    Đồ Chơi HATCHIMALS Pixies Cánh Thần Tiên
                </div>
                <div id="detail">
                    <span id="amount">x1</span> <br/>
                    <span>&#8363 244,000 VNĐ</span> <br/>
                    <span id="price-container"><b>Tổng cộng: &#8363 <span id="price">244,000 VNĐ</span></b></span>
                </div>
            </div>
            ...
            <div id="product">
                ...
                <div id="name">
                    Đồ Chơi Lắp Ráp Học Viện Ma Thuật Và Pháp Thuật Hogwarts LEGO HARRY POTTER 76419 

                </div>
                <div id="detail">
                    <span id="amount">x1</span> <br/>
                    <span>&#8363 5,229,000 VNĐ</span> <br/>
                    <span id="price-container"><b>Tổng cộng: &#8363 <span id="price">5,229,000 VNĐ</span></b></span>
                </div>
            </div>

            <div id="sum">
                <span id="logo"><b><i class="ti-money"></i>Thành tiền:</b></span>  <br/>
                <span id="total-price">&#8363 7,071,000 VNĐ</span>
            </div>
      </div>
