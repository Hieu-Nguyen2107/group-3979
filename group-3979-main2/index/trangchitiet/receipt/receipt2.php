...
<html>
    ...
    <body>
      ...
      <div class="body-receipt">
        ...
        <div id="code"><h1>MÃ ĐƠN HÀNG: #002</h1></div>
        ...
        <div id="receipt-list">
            ...
            <div id="product">
                ...
                <div id="name">
                   MLP Quả trứng kỳ diệu
                </div>
                <div id="detail">
                    <span id="amount">x1</span> <br/>
                    <span>&#8363 69,000 VNĐ</span> <br/>
                    <span id="price-container"><b>Tổng cộng: &#8363 <span id="price">69,000 VNĐ</span></b></span>
                </div>
            </div>
            ...
            <div id="product">
                ...
                <div id="name">
                    Mô hình Earthspark Warrior Megatron
                </div>
                <div id="detail">
                    <span id="amount">x1</span> <br/>
            ...
            <div id="sum">
                ...
                <span id="total-price">&#8363 1,667,000 VNĐ</span>
            </div>
      </div>
